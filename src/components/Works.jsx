  ...
  return (
    ...
    >
      <Tilt
        ...
        className='bg-tertiary p-4 sm:p-5 rounded-2xl w-full min-h-[400px]'
      >
...
const Works = () => {
  return (
    <div className="w-full">
      ...
      <div className='mt-10 sm:mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-7 w-full'>
